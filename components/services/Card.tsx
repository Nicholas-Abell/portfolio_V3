...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-dark to-darker text-light rounded-lg relative shadow-accent hover:shadow-xl lg:hover:scale-105 px-4 py-8 min-h-[240px] ease-out duration-700">
